# Android Project 3 - Moive.Yea

Submitted by: Christian Dogulass

MoiveMarathon is a movie browsing app that allows users to browse movies currently playing in theaters.
